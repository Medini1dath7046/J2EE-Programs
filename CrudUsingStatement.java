	...
	public static void main(String[] args) {
		...
		try {
			...
			while (a < 6) {
				...
				switch (sc.nextInt()) {
				case 1:
					String sql = "create table harsh383(id int(10),firstName varchar(20)," + "lastName varchar(20))";
					stmt.executeUpdate(sql);
					break;

				case 2:
					String sql1 = "INSERT INTO  Employees VALUES (213,4535,'medini','medh')";
				...
				case 3:
					...
					break;
				case 4:
					String sql3 = "SELECT id,age,  first, last FROM Employees";
					...
					break;
				case 5:
					String sql4 = "DELETE FROM Employees WHERE id = 130";
